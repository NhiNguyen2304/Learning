...
private final String searchPage = "loadSuggest.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<SuggestEventDTO> result = dao.search(search);
         
            
            if(result != null){
                request.setAttribute("SEARCHINFO", result);
                url = searchPage;
            }else{
                request.setAttribute("ERROR", "Can't find");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }finally{
