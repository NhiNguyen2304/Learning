...
private final String displayEvent = "viewEvent.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String search = request.getParameter("txtSearchEvent");
             result = dao.search(search);
            if(result != null){
                url = displayEvent;
                request.setAttribute("LOADEVENT", result);
            }else{
            ...
            log("ERROR at SearchEventController " +e.getMessage());
        }finally{
