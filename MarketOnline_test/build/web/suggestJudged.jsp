    ...
    <main class="hoc container clear">
        <div class="left-search">
            ...
            <form action="MainController" method="POST">
                <fieldset>
                    <button type="submit" value="LoadJudged" name="action" class="btmspace-15">All Suggest Judged</button><br/>
                </fieldset>
            </form>
        ...
        <c:if test="${not empty requestScope.JUDGED}">
            <table border="1" id="suggest table">
                ...
                <tbody>
                    ...
                    <c:forEach var="dto" items="${requestScope.JUDGED}" varStatus="counter">
                        <tr>
                            <td>${counter.count}</td>
                            <td>${dto.titleSug}</td>
                            <td>${dto.maker}</td>
